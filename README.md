...
An opinionated [Sapper](https://github.com/sveltejs/sapper) template using webpack & eslint . To clone it and get started:

```bash
# for Rollup
npx degit "cstrnt/sapper-template" my-app
